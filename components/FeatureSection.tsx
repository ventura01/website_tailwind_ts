  ...
  return (
    <section id="sec-features">
      <div className="container flex flex-col px-4 mx-auto mt-10 space-y-12 md:space-y-0 md:flex-row">
        <div className="fle flex-col space-y-12 md:w-1/2">
        ...
        <div className="flex flex-col space-y-8 md:w-1/2">
          <div className="flex flex-col space-y-3 md:space-0 md:space-x-6 md:flex-row">
            ...
            <div>
              ...
              <p className="text-darkGrayishBlue">
                ...
                unde mollitia minus eaque numquam quae fugit natus cum repellat
                quo nulla, quos repudiandae suscipit!
              </p>
            </div>
          </div>
          <div className="flex flex-col space-y-3 md:space-0 md:space-x-6 md:flex-row">
